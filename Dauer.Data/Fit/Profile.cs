...
namespace Dauer.Data.Fit
{
    ...
    public static class Profile
    {
        ...
        private static Mesg CreateFileIdMesg()
        {
            ...
            subfieldIndex = 0;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("FaveroProduct", 132, 1, 0, ""));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(1, 263);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("GarminProduct", 132, 1, 0, ""));
        ...
        private static Mesg CreateMesgCapabilitiesMesg()
        {
            ...
            subfieldIndex = 0;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("NumPerFile", 132, 1, 0, ""));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(2, 0);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("MaxPerFile", 132, 1, 0, ""));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(2, 1);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("MaxPerFileType", 132, 1, 0, ""));
        ...
        private static Mesg CreateWatchfaceSettingsMesg()
        {
            ...
            subfieldIndex = 0;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("DigitalLayout", 0, 1, 0, ""));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 0);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("AnalogLayout", 0, 1, 0, ""));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 1);
            subfieldIndex++;
            fieldIndex++;
        ...
        private static Mesg CreateDiveSettingsMesg()
        {
            ...
            subfieldIndex = 0;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("HeartRateAntplusDeviceType", 2, 1, 0, ""));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(19, 1);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("HeartRateLocalDeviceType", 2, 1, 0, ""));
        ...
        private static Mesg CreateSessionMesg()
        {
            ...
            subfieldIndex = 0;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("TotalStrides", 134, 1, 0, "strides"));
            ...
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(124, false, 16, 1000, 0)); // enhanced_avg_speed
            fieldIndex++;
            newMesg.SetField(new Field("MaxSpeed", 15, 132, 1000, 0, "m/s", false, Type.Uint16));
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(125, false, 16, 1000, 0)); // enhanced_max_speed
            fieldIndex++;
            ...
            subfieldIndex = 0;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("AvgRunningCadence", 2, 1, 0, "strides/min"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(5, 1);
            subfieldIndex++;
            fieldIndex++;
            newMesg.SetField(new Field("MaxCadence", 19, 2, 1, 0, "rpm", false, Type.Uint8));
            subfieldIndex = 0;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("MaxRunningCadence", 2, 1, 0, "strides/min"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(5, 1);
            subfieldIndex++;
            fieldIndex++;
            ...
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(126, false, 16, 5, 500)); // enhanced_avg_altitude
            fieldIndex++;
            newMesg.SetField(new Field("MaxAltitude", 50, 132, 5, 500, "m", false, Type.Uint16));
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(128, false, 16, 5, 500)); // enhanced_max_altitude
            fieldIndex++;
            ...
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(127, false, 16, 5, 500)); // enhanced_min_altitude
            fieldIndex++;
        ...
        private static Mesg CreateLapMesg()
        {
            ...
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(110, false, 16, 1000, 0)); // enhanced_avg_speed
            fieldIndex++;
            newMesg.SetField(new Field("MaxSpeed", 14, 132, 1000, 0, "m/s", false, Type.Uint16));
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(111, false, 16, 1000, 0)); // enhanced_max_speed
            fieldIndex++;
            ...
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(112, false, 16, 5, 500)); // enhanced_avg_altitude
            fieldIndex++;
            newMesg.SetField(new Field("MaxAltitude", 43, 132, 5, 500, "m", false, Type.Uint16));
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(114, false, 16, 5, 500)); // enhanced_max_altitude
            fieldIndex++;
            ...
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(113, false, 16, 5, 500)); // enhanced_min_altitude
            fieldIndex++;
        ...
        private static Mesg CreateRecordMesg()
        {
            ...
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(78, false, 16, 5, 500)); // enhanced_altitude
            fieldIndex++;
            ...
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(73, false, 16, 1000, 0)); // enhanced_speed
            fieldIndex++;
            ...
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(6, false, 12, 100, 0)); // speed
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(5, true, 12, 16, 0)); // distance
            fieldIndex++;
            ...
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(19, true, 8, 1, 0)); // total_cycles
            fieldIndex++;
            ...
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(29, true, 16, 1, 0)); // accumulated_power
            fieldIndex++;
        ...
        private static Mesg CreateEventMesg()
        {
            ...
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(3, false, 16, 1, 0)); // data
            fieldIndex++;
            newMesg.SetField(new Field("Data", 3, 134, 1, 0, "", false, Type.Uint32));
            subfieldIndex = 0;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("TimerTrigger", 0, 1, 0, ""));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 0);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("CoursePointIndex", 132, 1, 0, ""));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 10);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("BatteryLevel", 132, 1000, 0, "V"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 11);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("VirtualPartnerSpeed", 132, 1000, 0, "m/s"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 12);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("HrHighAlert", 2, 1, 0, "bpm"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 13);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("HrLowAlert", 2, 1, 0, "bpm"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 14);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("SpeedHighAlert", 134, 1000, 0, "m/s"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 15);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("SpeedLowAlert", 134, 1000, 0, "m/s"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 16);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("CadHighAlert", 132, 1, 0, "rpm"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 17);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("CadLowAlert", 132, 1, 0, "rpm"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 18);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("PowerHighAlert", 132, 1, 0, "watts"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 19);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("PowerLowAlert", 132, 1, 0, "watts"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 20);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("TimeDurationAlert", 134, 1000, 0, "s"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 23);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("DistanceDurationAlert", 134, 100, 0, "m"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 24);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("CalorieDurationAlert", 134, 1, 0, "calories"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 25);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("FitnessEquipmentState", 0, 1, 0, ""));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 27);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("SportPoint", 134, 1, 0, ""));
            ...
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("GearChangeData", 134, 1, 0, ""));
            ...
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("RiderPosition", 0, 1, 0, ""));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 44);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("CommTimeout", 132, 1, 0, ""));
        ...
        private static Mesg CreateDeviceInfoMesg()
        {
            ...
            subfieldIndex = 0;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("AntplusDeviceType", 2, 1, 0, ""));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(25, 1);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("AntDeviceType", 2, 1, 0, ""));
        ...
        private static Mesg CreateThreeDSensorCalibrationMesg()
        {
            ...
            subfieldIndex = 0;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("AccelCalFactor", 134, 1, 0, "g"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 0);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("GyroCalFactor", 134, 1, 0, "deg/s"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(0, 1);
            subfieldIndex++;
            fieldIndex++;
        ...
        private static Mesg CreateOneDSensorCalibrationMesg()
        {
            ...
            newMesg.SetField(new Field("CalibrationFactor", 1, 134, 1, 0, "", false, Type.Uint32));
            subfieldIndex = 0;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("BaroCalFactor", 134, 1, 0, "Pa"));
        ...
        private static Mesg CreateJumpMesg()
        {
            ...
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(8, false, 16, 1000, 0)); // enhanced_speed
            fieldIndex++;
        ...
        private static Mesg CreateSegmentLapMesg()
        {
            ...
            newMesg.SetField(new Field("TotalCycles", 10, 134, 1, 0, "cycles", false, Type.Uint32));
            subfieldIndex = 0;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("TotalStrokes", 134, 1, 0, "strokes"));
        ...
        private static Mesg CreateWorkoutStepMesg()
        {
            ...
            subfieldIndex = 0;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("DurationTime", 134, 1000, 0, "s"));
            ...
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("DurationDistance", 134, 100, 0, "m"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(1, 1);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("DurationHr", 134, 1, 0, "% or bpm"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(1, 2);
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(1, 3);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("DurationCalories", 134, 1, 0, "calories"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(1, 4);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("DurationStep", 134, 1, 0, ""));
            ...
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(1, 13);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("DurationPower", 134, 1, 0, "% or watts"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(1, 14);
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(1, 15);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("DurationReps", 134, 1, 0, ""));
            ...
            subfieldIndex = 0;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("TargetSpeedZone", 134, 1, 0, ""));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(3, 0);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("TargetHrZone", 134, 1, 0, ""));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(3, 1);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("TargetCadenceZone", 134, 1, 0, ""));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(3, 3);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("TargetPowerZone", 134, 1, 0, ""));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(3, 4);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("RepeatSteps", 134, 1, 0, ""));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(1, 6);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("RepeatTime", 134, 1000, 0, "s"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(1, 7);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("RepeatDistance", 134, 100, 0, "m"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(1, 8);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("RepeatCalories", 134, 1, 0, "calories"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(1, 9);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("RepeatHr", 134, 1, 0, "% or bpm"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(1, 10);
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(1, 11);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("RepeatPower", 134, 1, 0, "% or watts"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(1, 12);
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(1, 13);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("TargetStrokeType", 0, 1, 0, ""));
            ...
            subfieldIndex = 0;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("CustomTargetSpeedLow", 134, 1000, 0, "m/s"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(3, 0);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("CustomTargetHeartRateLow", 134, 1, 0, "% or bpm"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(3, 1);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("CustomTargetCadenceLow", 134, 1, 0, "rpm"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(3, 3);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("CustomTargetPowerLow", 134, 1, 0, "% or watts"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(3, 4);
            subfieldIndex++;
            fieldIndex++;
            newMesg.SetField(new Field("CustomTargetValueHigh", 6, 134, 1, 0, "", false, Type.Uint32));
            subfieldIndex = 0;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("CustomTargetSpeedHigh", 134, 1000, 0, "m/s"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(3, 0);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("CustomTargetHeartRateHigh", 134, 1, 0, "% or bpm"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(3, 1);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("CustomTargetCadenceHigh", 134, 1, 0, "rpm"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(3, 3);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("CustomTargetPowerHigh", 134, 1, 0, "% or watts"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(3, 4);
            subfieldIndex++;
            fieldIndex++;
        ...
        private static Mesg CreateMonitoringMesg()
        {
            ...
            subfieldIndex = 0;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("Steps", 134, 1, 0, "steps"));
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(5, 6);
            newMesg.Fields[fieldIndex].subfields[subfieldIndex].AddMap(5, 1);
            subfieldIndex++;
            newMesg.Fields[fieldIndex].subfields.Add(new Subfield("Strokes", 134, 2, 0, "strokes"));
            ...
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(5, false, 5, 1, 0)); // activity_type
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(28, false, 3, 1, 0)); // intensity
            fieldIndex++;
        ...
        private static Mesg CreateHrMesg()
        {
            ...
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(0, false, 8, 256, 0)); // fractional_timestamp
            fieldIndex++;
            ...
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(9, true, 12, 1024, 0)); // event_timestamp
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(9, true, 12, 1024, 0)); // event_timestamp
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(9, true, 12, 1024, 0)); // event_timestamp
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(9, true, 12, 1024, 0)); // event_timestamp
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(9, true, 12, 1024, 0)); // event_timestamp
        ...
        private static Mesg CreateAntRxMesg()
        {
            ...
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(3, false, 8, 1, 0)); // channel_number
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(4, false, 8, 1, 0)); // data
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(4, false, 8, 1, 0)); // data
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(4, false, 8, 1, 0)); // data
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(4, false, 8, 1, 0)); // data
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(4, false, 8, 1, 0)); // data
        ...
        private static Mesg CreateExdDataFieldConfigurationMesg()
        {
            ...
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(2, false, 4, 1, 0)); // field_id
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(3, false, 4, 1, 0)); // concept_count
            fieldIndex++;
        ...
        private static Mesg CreateExdDataConceptConfigurationMesg()
        {
            ...
            newMesg.SetField(new Field("ConceptField", 1, 13, 1, 0, "", false, Type.Byte));
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(2, false, 4, 1, 0)); // field_id
            newMesg.Fields[fieldIndex].components.Add(new FieldComponent(3, false, 4, 1, 0)); // concept_index
            fieldIndex++;
            newMesg.SetField(new Field("FieldId", 2, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;

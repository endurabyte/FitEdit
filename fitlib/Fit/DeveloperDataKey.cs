...
namespace fitsharplib.Fit
{
        ...
        : IComparable
    {
        ...
        /// <summary>
        /// Determines whether the specified <see cref="T:fitsharplib.Fit.DeveloperDataKey"/> is equal to the current <see cref="T:fitsharplib.Fit.DeveloperDataKey"/>.
        /// </summary>
        /// <returns>
        /// true if the specified <see cref="T:fitsharplib.Fit.DeveloperDataKey"/> is equal to the current <see cref="T:fitsharplib.Fit.DeveloperDataKey"/>; otherwise, false.
        /// </returns>
        /// <param name="other">
        /// The <see cref="T:fitsharplib.Fit.DeveloperDataKey"/> to compare with the current <see cref="T:fitsharplib.Fit.DeveloperDataKey"/>.
        /// </param>

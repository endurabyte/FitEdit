...
namespace fitsharplib.Fit
{
    ...
    public class Fit
    {
        ...
        public static readonly byte ProtocolVersion = fitsharplib.Fit.ProtocolVersion.V20.GetVersionByte();
        public static readonly byte ProtocolMajorVersion = fitsharplib.Fit.ProtocolVersion.V20.GetMajorVersion();
        public static readonly byte ProtocolMinorVersion = fitsharplib.Fit.ProtocolVersion.V20.GetMinorVersion();

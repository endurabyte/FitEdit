    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<ApiResponse> Register(RegisterDto parameters)
        {
            try
            {
                ...
                var requireConfirmEmail = Convert.ToBoolean(_configuration["BlazorApp:RequireConfirmedEmail"] ?? "false");
        ...
        public async Task<ApiResponse> ForgotPassword(ForgotPasswordDto parameters)
        {
            ...
            try
            {
                ...
                string callbackUrl = string.Format("{0}/Account/ResetPassword/{1}?token={2}", _configuration["BlazorApp:ApplicationUrl"], user.Id, token); //token must be a query string parameter as it is very long
            ...
            try
            {
                ...
                if (Convert.ToBoolean(_configuration["BlazorApp:RequireConfirmedEmail"] ?? "false"))
                {
                    ...
                    try
                    {
                        ...
                        string callbackUrl = string.Format("{0}/Account/ConfirmEmail/{1}?token={2}", _configuration["BlazorApp:ApplicationUrl"], user.Id, token);

...
namespace Dynastream.Fit
{
    ...
    public static class Profile
    {
        ...
        private static Mesg CreateEventMesg()
        {
            ...
            subfieldIndex++;
            newMesg.Fields[fieldIndex].AddSubfield(new Subfield("AutoActivityDetectDuration", 132, 1, 0, "min"));
            newMesg.Fields[fieldIndex].Subfields[subfieldIndex].AddMap(0, 54);
            subfieldIndex++;

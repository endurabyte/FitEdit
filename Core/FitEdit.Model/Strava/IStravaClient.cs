...
public interface IStravaClient
{
  ...
  Task<List<StravaActivity>> ListAllActivitiesAsync(NotifyBubble bubble, CancellationToken ct = default);
...
public class NullStravaClient : ReactiveObject, IStravaClient
{
  ...
  public Task<List<StravaActivity>> ListAllActivitiesAsync(NotifyBubble bubble, CancellationToken ct = default) => Task.FromResult(new List<StravaActivity>());

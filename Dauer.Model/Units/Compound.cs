...
namespace Dauer.Model.Units
{
    public static class Compound
    {
        ...
        /// </summary>
        public static Dictionary<CompoundUnit, double> MetersPerSecondConversions = new Dictionary<CompoundUnit, double>
        {
        ...
        /// </summary>
        public static Dictionary<CompoundUnit, double> SecondsConversions = new Dictionary<CompoundUnit, double>
        {
        ...
        /// </summary>
        public static double OverSeconds(this CompoundUnit unit, double d)
        {
            return d * SecondsConversions[unit];
        }

        /// <summary>
        /// Convert the given compound unit to meters per second
        /// </summary>
        public static double ToMetersPerSecond(this CompoundUnit unit, double d)
        {
            return d * MetersPerSecondConversions[unit];
        }
    }
}

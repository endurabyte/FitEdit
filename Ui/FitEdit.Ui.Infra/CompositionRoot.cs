...
public class CompositionRoot : ICompositionRoot
{
  ...
  protected virtual Task ConfigureAsync(ContainerBuilder builder)
  {
    ...
    FitEdit.Model.Log.Logger = log;
    FitEdit.Model.Log.Info($"BaseDirectory: {AppContext.BaseDirectory}");
    FitEdit.Model.Log.Info($"OSDescription: {RuntimeInformation.OSDescription}");

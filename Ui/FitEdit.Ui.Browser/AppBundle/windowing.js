export async function listenForMessages() {
  ...
  var notify = exports.FitEdit.Ui.Browser.Adapters.Windowing.WebWindowAdapterImpl.NotifyMessageReceived;
...
export async function listenForResize() {
  ...
  const { getAssemblyExports } = await globalThis.getDotnetRuntime(0);
  var exports = await getAssemblyExports("FitEdit.dll");
  var notify = exports.FitEdit.Ui.Browser.Adapters.Windowing.WebWindowAdapterImpl.NotifyWindowResized;
